 ...
 * * The function ::analogout_write sets the output voltage, specified as a percentage (float) in range [0.0 (GND), 1.0
 * (VCC)]
 * * The function ::analogout_write_u16 sets the output voltage, specified as unsigned 16-bit value [0 (GND), MAX_UINT16
 * (VCC)]
 * * The function ::analogout_read reads the current voltage value on the pin and returns a floating-point value
 * representing the current voltage in range [0.0 (GND), 1.0 (VCC)]
 * * The function ::analogout_read_u16 reads the current voltage value on the pin and returns the output voltage,
 * specified as unsigned 16-bit value [0 (GND), MAX_UINT16 (VCC)]
 * * The accuracy of the DAC is +/- 10%
 * * The DAC operations ::analogout_write, ::analogout_write_u16, ::analogout_read, ::analogout_read_u16 take less than
 * 20us to complete
