...
class Utest_func_bind
{
  ...
  public:
    ...
    inline void callback() { (*_callback_fn)(_callback_value); }
...
utest::v1::status_t timeout_failure_case_teardown(const Case *const source,
                                                  const size_t      passed,
                                                  const size_t      failed,
...
utest::v1::status_t timeout_success_case_failure_handler(const Case *const source,
                                                         const size_t      passed,
                                                         const size_t      failed,
                                                         const failure_t   failure)
{
...
utest::v1::status_t repeat_all_on_timeout_case_teardown(const Case *const source,
                                                        const size_t      passed,
                                                        const size_t      failed,
                                                        const failure_t   failure)
{
...
utest::v1::status_t repeat_handler_on_timeout_case_teardown(const Case *const source,
                                                            const size_t      passed,
                                                            const size_t      failed,
                                                            const failure_t   failure)
{
...
// Cases --------------------------------------------------------------------------------------------------------------
Case cases[] = {Case("Control: Timeout (Failure)",
                     timeout_failure_case,
                     timeout_failure_case_teardown,
                     timeout_failure_case_failure_handler),
                Case("Control: Timeout (Success)", timeout_success_case, timeout_success_case_failure_handler),
                Case("Control: Await", await_case),
                Case("Control: RepeatAllOnTimeout",
                     repeat_all_on_timeout_case_setup,
                     repeat_all_on_timeout_case,
                     repeat_all_on_timeout_case_teardown),
                Case("Control: RepeatHandlerOnTimeout",
                     repeat_handler_on_timeout_case_setup,
                     repeat_handler_on_timeout_case,
                     repeat_handler_on_timeout_case_teardown),
