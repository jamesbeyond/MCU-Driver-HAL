...
class Harness
{
  public:
    ...
    /// @cond
    __deprecated_message("Start case selection is done by returning the index from the test setup "
                         "handler!") static bool run(const Specification &specification, size_t start_case);
    /// @endcond
