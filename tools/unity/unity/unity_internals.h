...
#define UNITY_TEST_ASSERT_EQUAL_UINT8(expected, actual, line, message) \
    UnityAssertEqualNumber((_U_SINT)(_UU8)(expected),                  \
                           (_U_SINT)(_UU8)(actual),                    \
                           (message),                                  \
                           (UNITY_LINE_TYPE)(line),                    \
                           UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_EQUAL_UINT16(expected, actual, line, message) \
    UnityAssertEqualNumber((_U_SINT)(_UU16)(expected),                  \
                           (_U_SINT)(_UU16)(actual),                    \
                           (message),                                   \
                           (UNITY_LINE_TYPE)(line),                     \
                           UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_EQUAL_UINT32(expected, actual, line, message) \
    UnityAssertEqualNumber((_U_SINT)(_UU32)(expected),                  \
                           (_U_SINT)(_UU32)(actual),                    \
                           (message),                                   \
                           (UNITY_LINE_TYPE)(line),                     \
...
#define UNITY_TEST_ASSERT_INT_WITHIN(delta, expected, actual, line, message) \
    UnityAssertNumbersWithin(                                                \
        (delta), (_U_SINT)(expected), (_U_SINT)(actual), (message), (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT)
...
#define UNITY_TEST_ASSERT_UINT_WITHIN(delta, expected, actual, line, message) \
    UnityAssertNumbersWithin(                                                 \
        (delta), (_U_SINT)(expected), (_U_SINT)(actual), (message), (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT)
...
#define UNITY_TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len, line, message) \
    UnityAssertEqualStringLen(                                                   \
        (const char *)(expected), (const char *)(actual), (_UU32)(len), (message), (UNITY_LINE_TYPE)(line))
...
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE(expected, actual, line, message) \
    UNITY_TEST_ASSERT_DOUBLE_WITHIN(                                    \
        (_UD)(expected) * (_UD)UNITY_DOUBLE_PRECISION, (_UD)expected, (_UD)actual, (UNITY_LINE_TYPE)(line), message)
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(expected, actual, num_elements, line, message) \
...
#define UNITY_TEST_SKIP(line, message)                      \
    {                                                       \
        UnitySkipPrint((message), (UNITY_LINE_TYPE)(line)); \
        return;                                             \
    }
#define UNITY_TEST_SKIP_UNLESS(condition, line, message) \
    if (!(condition))                                    \
    UNITY_TEST_SKIP((line), (message))
